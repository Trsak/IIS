...
--
-- Počítač: localhost
-- Vygenerováno: Ned 02. pro 2018, 23:29
...
(21, '9780439023481', 'The Hunger Games', 'Unknown', 'The First Book of the Hunger Games', '0000-00-00', 374, 'In a future North America, where the rulers of Panem maintain control through an annual televised survival competition pitting young people from each of the twelve districts against one another, sixteen-year-old Katniss''s skills are put to the test when she voluntarily takes her younger sister''s place.', 64, 0, 'http://books.google.com/books/content?id=sJdUAzLUNyAC&printsec=frontcover&img=1&zoom=1&source=gbs_api'),
(22, '9781444778519', 'Angelfall', 'Hodder Paperbacks', NULL, '0000-00-00', 325, 'The official print edition of the internet phenomenon. Already over 8,000 five star different reader reviews. (And counting.) It''s been six weeks since the angels of the apocalypse destroyed the world as we know it. Only pockets of humanity remain. Savage street gangs rule the day while fear and superstition rule the night. When angels fly away with a helpless girl, her seventeen-year-old sister Penryn will do anything to get her back...', 51, 0, ''),
...
(2, 'Peter', 'Parker', 'zamestnanec@zamestnanec.cz', '$2y$10$DKUYQld5fGvuoI07hcmnkOBCWEV3mxtQuxI4KRSB.GSfgD/06SFR2', '774126169', '1991-06-05', '2019-03-21', 1);
